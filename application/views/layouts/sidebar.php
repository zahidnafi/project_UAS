<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?php echo base_url(); ?>" class="brand-link">
    ...
    <span class="brand-text font-weight-light">IEvO</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block">Zubair Adnan Arsyad</a>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="button" class="btn btn-primary"><a href="<?php echo base_url('Login/login') ?>" class="text-white">Logout</a></button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
